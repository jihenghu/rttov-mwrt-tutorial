gfortran -mcmodel=large -ffpe-summary=none -I/home/hjh/netcdf/include -I/home/hjh/hdf5/include -L/home/hjh/netcdf/lib -lnetcdff -lnetcdf  -L/home/hjh/hdf5/lib -lhdf5_fortran -c fy3g_mwri_retrieve_emiss.f90 -o ./fy3g_mwri_retrieve_emiss.o
...
gfortran -o ./fy3g_mwri_retrieve_emiss_swath.exe \
./fy3g_mwri_retrieve_emiss.o ./rttov_retrieve_emiss.o \
